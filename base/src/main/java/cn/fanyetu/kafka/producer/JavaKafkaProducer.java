...
public class JavaKafkaProducer {
	...
	private Logger logger = LoggerFactory.getLogger(JavaKafkaProducer.class);

	public static final String TOPIC_NAME = "portal_create_emp";
	...
	@Test
	public void test1(){
		String brokerList = "35.10.28.201:9092";
		 ...
		 */
		props.put("partitioner.class", "cn.fanyetu.kafka.producer.JavaKafkaProducerPartitioner");
